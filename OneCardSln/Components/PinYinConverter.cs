...
*/
    ...
    public class PinYinConverter
    {
        ...
        /// <param name="str"></param>   
        /// <returns></returns>  
        public static string GetFirstInUpper(string str)
        {
            string result = GetFirst(str);
        ...
        /// <param name="str"></param>   
        /// <returns></returns>  
        public static string GetFirstInLower(string str)
        {
            string result = GetFirst(str);
            if (!string.IsNullOrWhiteSpace(result))
            {
        ...
        /// <param name="ch"></param>   
        /// <returns></returns>   
        public static String GetFull(Char ch)
        {
            // 拉丁字符               
        ...
        /// <param name="str">汉字字符串</param>   
        /// <returns>转换后的拼音(全拼)字符串</returns>  
        public static string GetFullInUpper(string str)
        {
            string result = GetFull(str);
            if (!string.IsNullOrWhiteSpace(result))
            {
                result = result.ToUpper();
            }
        ...
        /// <param name="str">汉字字符串</param>   
        /// <returns>转换后的拼音(全拼)字符串</returns>  
        public static string GetFullInLower(string str)
        {
            string result = GetFull(str);
            if (!string.IsNullOrWhiteSpace(result))
            {
