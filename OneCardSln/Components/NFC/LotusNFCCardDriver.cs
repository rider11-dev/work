...
namespace OneCardSln.Components.NFC
{
    //回调函数
    public delegate int OnLotusCardExtendReadWriteCallBackFunc(int bRead, ref byte pReadWriteBuffer, int nBufferLength);
    ...
    class CLotusCardDriver
    {
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSelect", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSelect(int nDeviceHandle, ref LotusCardParamStruct sttLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardAuthentication", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardAuthentication(int nDeviceHandle, int nAuthMode, int nSectionIndex, ref  LotusCardParamStruct sttLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardHalt", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardHalt(int nDeviceHandle);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardRead", SetLastError = true,
         CharSet = CharSet.Ansi, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardRead(int nDeviceHandle, int nAddress, ref  LotusCardParamStruct sttLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardWrite", SetLastError = true,
         CharSet = CharSet.Ansi, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardWrite(int nDeviceHandle, int nAddress, ref  LotusCardParamStruct sttLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardIncrement", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardIncrement(int nDeviceHandle, int nAddress, int nValue);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardDecrement", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardDecrement(int nDeviceHandle, int nAddress, int nValue);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardRestore", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardRestore(int nDeviceHandle, int nAddress);
        /**
         * 内部寄存器传入卡的卡数据块
         * @param nDeviceHandle
         *            设备句柄
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardTransfer", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardTransfer(int nDeviceHandle, int nAddress);
        /**
         * 装载密钥
         * @param nDeviceHandle
         *            设备句柄
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardLoadKey", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardLoadKey(int nDeviceHandle, int nAuthMode, int nSectionIndex, ref  LotusCardParamStruct sttLotusCardParam);
        /**
         * 发送指令 用于CPU卡
         * @param nDeviceHandle
         *            设备句柄
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSendCpuCommand", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSendCpuCommand(int nDeviceHandle, int nTimeOut, ref  LotusCardParamStruct sttLotusCardParam);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardReadText", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardReadText(int nDeviceHandle, int nSectionIndex, ref byte pTextInfo, uint unTextInfoLength);
        /**
        * 写指定地址文本
        * @param nSectionIndex 扇区索引
        * @param pTextInfo 结果值（读写缓冲）
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardWriteText", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardWriteText(int nDeviceHandle, int nSectionIndex, Byte[] pTextInfo, uint unTextInfoLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetCardNo", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetCardNo(int nDeviceHandle, int nRequestType,
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardInitValue", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardInitValue(int nDeviceHandle, int nAddress, int nValue);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardChangePassword", SetLastError = true,
         CharSet = CharSet.Ansi, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardChangePassword(int nDeviceHandle, int nSectionIndex, string pPasswordA, string pPasswordB);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetBankCardNo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetBankCardNo(int nDeviceHandle, ref byte pBankCardNo, uint unBankCardNoLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSendEspEnterIspCommand", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSendEspEnterIspCommand(int nDeviceHandle);
        /**
         * 发送Esp isp开始动作
         * @param nDeviceHandle
         *            设备句柄
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSendEspIspBeginCommand", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSendEspIspBeginCommand(int nDeviceHandle);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardWriteEspFile2Flash", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardWriteEspFile2Flash(int nDeviceHandle, ref char pszFilePath, UInt32 unOffset, OnLotusCardWrite2FlashCallBackFunc pOnLotusCardWrite2FlashCallBack);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSendEspIspEndCommand", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSendEspIspEndCommand(int nDeviceHandle);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardReadData", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardReadData(int nDeviceHandle, int nRequestType, int nAddress, byte ucUseParameterPassWord,
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardWriteData", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardWriteData(int nDeviceHandle, int nAddress, byte ucBeepLen, byte ucUseHalt, ref LotusCardParamStruct pLotusCardParam);
        /******************************** 以下函数为WIFI操作函数 ***************************/
        /**
         * 扫描AP
         * @param nDeviceHandle
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardScanAp", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardScanAp(int nDeviceHandle, ref BssInfoStruct pBssInfoArray, UInt32 unBssInfoArraySize);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetWifiMode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetWifiMode(int nDeviceHandle, ref byte pucWifiMode);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSetWifiMode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSetWifiMode(int nDeviceHandle, byte ucWifiMode);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetStaInfo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetStaInfo(int nDeviceHandle, ref StaInfoStruct pStaInfoStruct);
        /**
        * 设置STA信息
         * @param nDeviceHandle
         *            设备句柄
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSetStaInfo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSetStaInfo(int nDeviceHandle, ref StaInfoStruct pStaInfoStruct);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetErrorCode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32 LotusCardGetErrorCode(int nDeviceHandle);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetTwoIdErrorCode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32 LotusCardGetTwoIdErrorCode(int nDeviceHandle);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetErrorInfo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardGetErrorInfo(int nDeviceHandle, LotusCardErrorCode errCode, ref char pszErrorInfo, UInt32 unErrorInfoLength);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetTwoIdErrorInfo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardGetTwoIdErrorInfo(int nDeviceHandle, TwoIdErrorCode errCode, ref char pszErrorInfo, UInt32 unErrorInfoLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSetCardType", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSetCardType(int nDeviceHandle, char cCardType);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardFelicaPolling", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardFelicaPolling(int nDeviceHandle, byte unTimerSlot, ref LotusCardParamStruct pLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSendSamvCommand", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSendSamvCommand(int nDeviceHandle, ref LotusCardParamStruct pLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSendCosResult2Samv", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSendCosResult2Samv(int nDeviceHandle, ref LotusCardParamStruct pLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetSamvUartData", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetSamvUartData(int nDeviceHandle, ref LotusCardParamStruct pLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetTwoIdInfo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetTwoIdInfo(int nDeviceHandle, ref IDCardStruct pTwoIdInfo);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetTwoIdInfoByServer", SetLastError = true,
             CharSet = CharSet.Ansi, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetTwoIdInfoByServer(int nDeviceHandle, string pszServerIp, ref IDCardStruct pTwoIdInfo);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardReadNfcBuffer", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardReadNfcBuffer(int nDeviceHandle, ref char pszNfcBuffer, UInt32 unNfcBufferLength);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardWriteNfcBuffer", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardWriteNfcBuffer(int nDeviceHandle, ref char pszNfcBuffer, UInt32 unNfcBufferLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardRequestB", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardRequestB(int nDeviceHandle, int nRequestType,
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSelectB", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSelectB(int nDeviceHandle,
            ref LotusCardParamStruct pLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardHaltB", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardHaltB(int nDeviceHandle);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetUhfFwVersion", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetUhfFwVersion(int nDeviceHandle, byte ucVersionType, ref char pUhfFwVersionInfo, UInt32 unVersionInfoLength);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfInventory", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfInventory(int nDeviceHandle, ref UInt32 unInventoryCount);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfGetInventoryStruct", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfGetInventoryStruct(int nDeviceHandle, byte ucInventoryIndex, ref UhfInventoryStruct pUhfInventory);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfReadMulti", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfReadMulti(int nDeviceHandle, ref byte ucRssi, ref UInt16 usPC, ref  byte pEPCBuffer,
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfStopMulti", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfStopMulti(int nDeviceHandle);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfGetPower", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfGetPower(int nDeviceHandle, ref UInt16 usPower);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetPower", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetPower(int nDeviceHandle, UInt16 usPower);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetRegion", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetRegion(int nDeviceHandle, byte ucRegion);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfGetRfChannel", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfGetRfChannel(int nDeviceHandle, ref byte ucRfChannel);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetRfChannel", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetRfChannel(int nDeviceHandle, byte ucRfChannel);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetFHSS", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetFHSS(int nDeviceHandle, byte ucFHSS);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfGetQueryParamter", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfGetQueryParamter(int nDeviceHandle, ref UInt16 usQueryParameter);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetQueryParamter", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetQueryParamter(int nDeviceHandle, UInt16 usQueryParameter);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetCW", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetCW(int nDeviceHandle, byte ucCW);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfScanJammer", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfScanJammer(int nDeviceHandle, ref byte ucChannelLow, ref byte ucChannelHigh, ref byte parrJammerBuffer, ref UInt32 unJammerBufferLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfScanRssi", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfScanRssi(int nDeviceHandle, ref byte ucChannelLow, ref byte ucChannelHigh, ref byte parrRssiBuffer, ref UInt32 unRssiBufferLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfReadModemParameter", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfReadModemParameter(int nDeviceHandle, ref byte ucMixerGain, ref byte ucIFGain, ref UInt16 usThrd);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetModemParameter", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetModemParameter(int nDeviceHandle, byte ucMixerGain, byte ucIFGain, UInt16 usThrd);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetInventoryMode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetInventoryMode(int nDeviceHandle, byte ucInventoryMode);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfSetSelectParameter", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfSetSelectParameter(int nDeviceHandle, byte ucSelParam, UInt32 unPtr, byte ucMaskLen, byte ucTruncate,
                                                                                                                                                                       ref byte parrMask, UInt32 unMaskLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfReadData", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfReadData(int nDeviceHandle, UInt32 unAccessPassword, byte ucMemBank, UInt16 usSAdreess, UInt16 usDataLength,
            ref byte parrDataBuffer, ref UInt32 unDataBufferLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfWriteData", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfWriteData(int nDeviceHandle, UInt32 unAccessPassword, byte ucMemBank, UInt16 usSAdreess, UInt16 usDataLength,
            ref byte parrDataBuffer, ref UInt32 unDataBufferLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfLockUnLock", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfLockUnLock(int nDeviceHandle, UInt32 unAccessPassword, ref byte parrLockLd, UInt32 unLockLdLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardM100UhfKill", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardM100UhfKill(int nDeviceHandle, UInt32 unKillPassword);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetDeviceNo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetDeviceNo(int nDeviceHandle, ref char pstrDeviceNo, UInt32 unDeviceNoLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetTwoGenerationIDCardNo", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetTwoGenerationIDCardNo(int nDeviceHandle, ref byte pstrTwoGenerationID, UInt32 unTwoGenerationIDLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetServerIpPort", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetServerIpPort(int nDeviceHandle, ref UInt32 punIpAddress, ref UInt16 pusPort);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetTwoIdSexByCode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardGetTwoIdSexByCode(int nDeviceHandle, ref char pszSexCode, ref char pszSexBuffer, int nSexBufferLength);
        /**
         * 根据编码获取民族字符串
         * 
         * @param nDeviceHandle
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetTwoIdNationByCode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardGetTwoIdNationByCode(int nDeviceHandle, ref char pszNationCode, ref char pszNationBuffer, int nNationBufferLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardBase64Encode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardBase64Encode(int nDeviceHandle, ref byte pSrcDataBuffer, int nSrcDataLen, ref byte pDestDataBuffer, int nDestDataLen);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetEncodeNewLen", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetEncodeNewLen(int nDeviceHandle, ref char pSrcDataBuffer, int nSrcDataLen);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardBase64Decode", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardBase64Decode(int nDeviceHandle, ref byte pSrcDataBuffer, int nSrcDataLen, ref byte pDestDataBuffer, int nDestDataLen);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetDecodeNewLen", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetDecodeNewLen(int nDeviceHandle, ref char pSrcDataBuffer, int nSrcDataLen);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetIdRandom", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardGetIdRandom(ref byte pszRandom, UInt32 unRandomLength);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetMcuConfig", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetMcuConfig(int nDeviceHandle, ref byte pMcuConfig, UInt32 unMcuConfigLegnth);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardGetIspOption", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardGetIspOption(int nDeviceHandle, ref byte pIspOption, UInt32 unIspOptionLegnth);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSetIspOption", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSetIspOption(int nDeviceHandle, ref byte pIspOption, UInt32 unIspOptionLegnth);
        ...
        */
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSetRfOnOff", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSetRfOnOff(int nDeviceHandle, byte ucRfOnOff);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSetLedStatus", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSetLedStatus(int nDeviceHandle, byte ucLedStatus);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardResetRfIc", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardResetRfIc(int nDeviceHandle);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardNtagGetVersion", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardNtagGetVersion(int nDeviceHandle, ref byte pNtagVersionBuffer, uint unNtagVersionBuffeLegnth);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardNtagPwdAuth", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardNtagPwdAuth(int nDeviceHandle, ref byte pNtagPasswordBuffer, uint unNtagPasswordBuffeLegnth);
         ...
         * @return true = 成功
         */
        public int Request(int nDeviceHandle, int nRequestType,
               ref  LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int Select(int nDeviceHandle,
                ref  LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int Authentication(int nDeviceHandle, int nAuthMode,
         ...
         * @return true = 成功
         */
        public int Halt(int nDeviceHandle)
        {
         ...
         * @return true = 成功
         */
        public int Read(int nDeviceHandle, int nAddress,
                ref  LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int Write(int nDeviceHandle, int nAddress,
                ref  LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int Increment(int nDeviceHandle, int nAddress, int nValue)
        {
         ...
         * @return true = 成功
         */
        public int Decrement(int nDeviceHandle, int nAddress, int nValue)
        {
         ...
         * @return true = 成功
         */
        public int LoadKey(int nDeviceHandle, int nAuthMode,
                int nSectionIndex, ref  LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int SendCpuCommand(int nDeviceHandle, int nTimeOut,
                ref  LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int GetCardNo(int nDeviceHandle, int nRequestType,
                ref  LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int InitValue(int nDeviceHandle, int nAddress, int nValue)
        {
         ...
         * @return true = 成功
         */
        public int ChangePassword(int nDeviceHandle, int nSectionIndex,
