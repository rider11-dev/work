...
namespace OneCardSln.WebApi.Models.Base
{
    public class AddDictViewModel
    {
        ...
        [MaxLength(20, ErrorMessageResourceName = "Dict_Code_Length", ErrorMessageResourceType = typeof(OneCardSln.Components.Resource.ViewModelResource))]
        ...
        [MaxLength(20, ErrorMessageResourceName = "Dict_Name_Length", ErrorMessageResourceType = typeof(OneCardSln.Components.Resource.ViewModelResource))]
        public string dict_name { get; set; }

        [Required(ErrorMessageResourceName = "Dict_Type_Require", ErrorMessageResourceType = typeof(OneCardSln.Components.Resource.ViewModelResource))]
