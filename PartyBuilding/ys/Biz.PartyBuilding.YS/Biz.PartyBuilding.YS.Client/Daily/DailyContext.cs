...
　　至此，大会圆满结束。",
        ...
        static List<dynamic> _town_villages;
        public static List<dynamic> town_villages
        {
            get
            {
                if (_town_villages == null)
                {
                    _town_villages = PublicHelper.GetDataFromJsonFile<dynamic>("xzdw");
                }
                return _town_villages;
            }
        }
    }
}
