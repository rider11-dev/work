...
namespace MyNet.WebApi.Models.Card
{
    ...
    public class PayViewModel
    {
        ...
        /// 消费金额
        /// </summary>
        [Required(ErrorMessageResourceName = "Pay_Amount_Require", ErrorMessageResourceType = typeof(MyNet.Components.Resource.ViewModelResource))]
        public decimal amount { get; set; }
        /// <summary>
        /// 消费来源：手机端、电脑商城
        /// </summary>
        [MaxLength(255, ErrorMessageResourceName = "Pay_Src_Length", ErrorMessageResourceType = typeof(MyNet.Components.Resource.ViewModelResource))]
