using MyNet.Client.Pages.CustomQuery.Basic;
...
namespace MyNet.Client.Models.CustomQuery
{
    public class FieldMngViewModel : MngViewModel
    {
        ...
        protected override void DelAction(object param)
        {
            ...
            var rst = HttpUtils.PostResult(ApiUtils.GetApiUrl(ApiKeys.Cq_FieldDel),
                new
                {
                    pks = ids.ToArray()
                }, ClientContext.Token);
        ...
        public static IEnumerable<FieldViewModel> GetFields(PageQuery page)
        {
            ...
            var rst = HttpUtils.PostResult(ApiUtils.GetApiUrl(ApiKeys.Cq_FieldPage),
              new
              {
                  pageIndex = page.pageIndex,
                  pageSize = page.pageSize,
